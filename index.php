<?php
	...
	$query_perfil=mysqli_query($con,"select * from Perfil where PerfilId=1");
	$rw=mysqli_fetch_assoc($query_perfil);
	$sql=mysqli_query($con, "select LAST_INSERT_ID(PresupuestoId) as last from Presupuesto order by PresupuestoId desc limit 0,1 ");
...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Presupuesto de trabajo - <?php echo $rw['PerfilNombreComercial'];?></title>
       ...
       <form class="form-horizontal" role="form" id="datos_presupuesto" method="post">
        <div id="print-area">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <a href="http://localhost/sistema-presupuesto/" target="_blank">  <img src="assets/img/logo.png" alt="Logo sistemas web" /></a>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <strong>Email : </strong> <?php echo $rw['PerfilEmail'];?>
                    <br />
                    <strong>Teléfono :</strong> <?php echo $rw['PerfilTelefono'];?> <br />
					<strong>Sitio web :</strong> <?php echo $rw['PerfilWeb'];?> 
                   
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <strong><?php echo $rw['PerfilNombreComercial'];?>  </strong>
                    <br />
                    Dirección : <?php echo $rw['PerfilDireccion'];?> 
                </div>
